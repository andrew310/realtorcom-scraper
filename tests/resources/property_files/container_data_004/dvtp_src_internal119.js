...
(b+="&scah="+c.screen.availHeight,b+="&scaw="+c.screen.availWidth)}catch(e){}return b||""}function M(b,c,e){e=e||150;var f=window._dv_win||window;if(f.document&&f.document.body)return c&&c.parentNode?c.parentNode.insertBefore(b,c):f.document.body.insertBefore(b,f.document.body.firstChild),!0;if(0<e)setTimeout(function(){M(b,c,--e)},20);else return!1}function N(b){var c=null;try{if(c=b&&b.contentDocument)return c}catch(e){}try{if(c=b.contentWindow&&b.contentWindow.document)return c}catch(e){}try{if(c=
window._dv_win.frames&&window._dv_win.frames[b.name]&&window._dv_win.frames[b.name].document)return c}catch(e){}return null}function S(b){var c=document.createElement("iframe");c.name=c.id=window._dv_win.dv_config.emptyIframeID||"iframe_"+Math.floor(1E12*(Math.random()+""));c.width=0;c.height=0;c.style.display="none";c.src=b;return c}function ca(b,c,e,f,d,g,l,m){var x=window._dv_win.dv_config=window._dv_win.dv_config||{};x.tpsErrAddress=x.tpsAddress||"tps30.doubleverify.com";x.cdnAddress=x.cdnAddress||
"cdn.doubleverify.com";var k={};k[b]=c;k.dvp_jsErrUrl=e;k.dvp_jsErrMsg=encodeURIComponent("Error loading visit.js");b=dv_CreateAndGetErrorImp(x.tpsErrAddress+"/visit.jpg?ctx=818052&cmp=1619415&dvtagver=6.1.src&dvp_isLostImp=1",k);f=f||"function() {}";x=c="";m&&(k=dv_GetParam(g,"dvp_evl")?m.eval?m.eval:m.main:m.eval&&m.rate&&100*Math.random()<m.rate?m.eval:m.main)&&(c='<script type="text/javascript" id="TPSCall" src="'+d+"/"+m.src+k+'.js">\x3c/script>',x=dv_GetParam(g,"dvp_evl")?"":"&dvp_evl=1");return'<html><head><script type="text/javascript">('+
function(b,c,d,e){try{window.dvSrc=b,window.ep={ep1:c,ep2:d,ep3:e},window.$dv=window.$dv||parent.$dv,window.$dv.dvObjType="dv",window.$frmId=Math.random().toString(36)+Math.random().toString(36)}catch(h){}}.toString()+')("'+g+'","'+l.ep1+'","'+l.ep2+'","'+l.ep3+'");\x3c/script></head><body>'+c+'<script type="text/javascript">('+f+')("'+d+'");\x3c/script><script type="text/javascript" id="TPSCall" src="'+e+x+'">\x3c/script><script type="text/javascript">('+function(b){var c=document.getElementById("TPSCall");
try{c.onerror=function(){try{(new Image).src=b}catch(r){}}}catch(r){}c&&c.readyState?(c.onreadystatechange=function(){"complete"==c.readyState&&document.close()},"complete"==c.readyState&&document.close()):document.close()}.toString()+')("'+b+'");\x3c/script></body></html>'}function T(b){var c={};try{for(var e=/[\?&]([^&]*)=([^&#]*)/gi,f=e.exec(b);null!=f;)"eparams"!==f[1]&&(c[f[1]]=f[2]),f=e.exec(b);return c}catch(d){return c}}function da(b){for(var c=0;10>c&&b!=window._dv_win.top;)c++,b=b.parent;
return c}function ea(b){try{if(1>=b.depth)return{url:"",depth:""};var c=[];c.push({win:window._dv_win.top,depth:0});for(var e,f=1,d=0;0<f&&100>d;){try{if(d++,e=c.shift(),f--,0<e.win.location.toString().length&&e.win!=b)return 0==e.win.document.referrer.length||0==e.depth?{url:e.win.location,depth:e.depth}:{url:e.win.document.referrer,depth:e.depth-1}}catch(m){}var g=e.win.frames.length;for(var l=0;l<g;l++)c.push({win:e.win.frames[l],depth:e.depth+1}),f++}return{url:"",depth:""}}catch(m){return{url:"",
depth:""}}}function fa(){var b=window._dv_win[P("=@42E:@?")][P("2?46DE@C~C:8:?D")];if(b&&0<b.length){var c=[];c[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var e=0;e<b.length;e++)c[e+1]=b[e];return c.reverse().join(",")}return null}function P(b){var c=String(),e;for(e=0;e<b.length;e++){var f=b.charAt(e);var d="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(f);0<=d&&(f="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((d+
47)%94));c+=f}return c}function ha(){try{var b=0,c=function(c,d){d&&32>c&&(b=(b|1<<c)>>>0)},e=function(b,c){return function(){return b.apply(c,arguments)}},f="svg"===document.documentElement.nodeName.toLowerCase(),d=function(){return"function"!==typeof document.createElement?document.createElement(arguments[0]):f?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},g=["Moz","O","ms","Webkit"],l=["moz","o","ms","webkit"],
m={style:d("modernizr").style},x=function(b,c){function e(){h&&(delete m.style,delete m.modElem)}var g;for(g=["modernizr","tspan","samp"];!m.style&&g.length;){var h=!0;m.modElem=d(g.shift());m.style=m.modElem.style}var f=b.length;for(g=0;g<f;g++){var l=b[g];~(""+l).indexOf("-")&&(l=cssToDOM(l));if(void 0!==m.style[l])return e(),"pfx"==c?l:!0}e();return!1},k=function(b,c,d){var f=b.charAt(0).toUpperCase()+b.slice(1),h=(b+" "+g.join(f+" ")+f).split(" ");if("string"===typeof c||"undefined"===typeof c)return x(h,
c);h=(b+" "+l.join(f+" ")+f).split(" ");for(var k in h)if(h[k]in c){if(!1===d)return h[k];b=c[h[k]];return"function"===typeof b?e(b,d||c):b}return!1};c(0,!0);c(1,k("requestFileSystem",window));c(2,window.CSS?"function"==typeof window.CSS.escape:!1);c(3,k("shapeOutside","content-box",!0));return b}catch(O){return 0}}function J(){var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););}catch(e){}return b}function ia(){try{var b=J(),c=0,e=0,f=function(b,d,f){f&&(c=
(c|1<<b)>>>0,e=(e|1<<d)>>>0)},d=b.document;f(14,0,b.playerInstance&&d.querySelector('script[src*="ads-player.com"]'));f(14,1,(b.CustomWLAdServer||b.DbcbdConfig)&&(a=d.querySelector('p[class="footerCopyright"]'),a&&a.textContent.match(/ MangaLife 2016/)));f(15,2,b.zpz&&b.zpz.createPlayer);f(15,3,b.vdApp&&b.vdApp.createPlayer);f(15,4,d.querySelector('body>div[class="z-z-z"]'));f(16,5,b.xy_checksum&&b.place_player&&(b.logjwonready&&b.logContentPauseRequested||b.jwplayer));f(17,6,b==b.top&&""==d.title?
(a=d.querySelector('body>object[id="player"]'),a&&a.data&&1<a.data.indexOf("jwplayer")&&"visibility: visible;"==a.getAttribute("style")):!1);f(17,7,d.querySelector('script[src*="sitewebvideo.com"]'));f(17,8,b.InitPage&&b.cef&&b.InitAd);f(17,9,b==b.top&&""==d.title?(a=d.querySelector("body>#player"),null!=a&&null!=(null!=a.querySelector('div[id*="opti-ad"]')||a.querySelector('iframe[src="about:blank"]'))):!1);f(17,10,b==b.top&&""==d.title&&b.InitAdPlayer?(a=d.querySelector('body>div[id="kt_player"]'),
null!=a&&null!=a.querySelector('div[class="flash-blocker"]')):!1);f(17,11,null!=b.clickplayer&&null!=b.checkRdy2);f(19,12,b.instance&&b.inject&&d.querySelector('path[id="cp-search-0"]'));return{f:c,s:e}}catch(g){return null}}function ja(){try{var b="&fcifrms="+window.top.length;window.history&&(b+="&brh="+window.history.length);var c=J(),e=c.document;if(c==window.top){b+="&fwc="+((c.FB?1:0)+(c.twttr?2:0)+(c.outbrain?4:0)+(c._taboola?8:0));try{e.cookie&&(b+="&fcl="+e.cookie.length)}catch(f){}c.performance&&
c.performance.timing&&0<c.performance.timing.domainLookupStart&&0<c.performance.timing.domainLookupEnd&&(b+="&flt="+(c.performance.timing.domainLookupEnd-c.performance.timing.domainLookupStart));e.querySelectorAll&&(b+="&fec="+e.querySelectorAll("*").length)}return b}catch(f){return""}}function ka(){function b(b){if(null==b||""==b)return"";var c=function(b,c){return b<<c|b>>>32-c},d=function(b){for(var c="",d,e=7;0<=e;e--)d=b>>>4*e&15,c+=d.toString(16);return c},e=[1518500249,1859775393,2400959708,
3395469782];b+=String.fromCharCode(128);for(var f=Math.ceil((b.length/4+2)/16),g=Array(f),v=0;v<f;v++){g[v]=Array(16);for(var r=0;16>r;r++)g[v][r]=b.charCodeAt(64*v+4*r)<<24|b.charCodeAt(64*v+4*r+1)<<16|b.charCodeAt(64*v+4*r+2)<<8|b.charCodeAt(64*v+4*r+3)}g[f-1][14]=8*(b.length-1)/Math.pow(2,32);g[f-1][14]=Math.floor(g[f-1][14]);g[f-1][15]=8*(b.length-1)&4294967295;b=1732584193;r=4023233417;var y=2562383102,h=271733878,G=3285377520,z=Array(80);for(v=0;v<f;v++){for(var p=0;16>p;p++)z[p]=g[v][p];for(p=
16;80>p;p++)z[p]=c(z[p-3]^z[p-8]^z[p-14]^z[p-16],1);var B=b;var t=r;var w=y;var E=h;var I=G;for(p=0;80>p;p++){var q=Math.floor(p/20),n=c(B,5);a:{switch(q){case 0:var u=t&w^~t&E;break a;case 1:u=t^w^E;break a;case 2:u=t&w^t&E^w&E;break a;case 3:u=t^w^E;break a}u=void 0}q=n+u+I+e[q]+z[p]&4294967295;I=E;E=w;w=c(t,30);t=B;B=q}b=b+B&4294967295;r=r+t&4294967295;y=y+w&4294967295;h=h+E&4294967295;G=G+I&4294967295}return d(b)+d(r)+d(y)+d(h)+d(G)}function c(){try{return!!window.sessionStorage}catch(g){return!0}}
...
d.push(["tz",(new Date).getTimezoneOffset()]);d.push(["hss",c()?"1":"0"]);d.push(["hls",e()?"1":"0"]);d.push(["odb",typeof window.openDatabase||""]);d.push(["cpu",navigator.cpuClass||""]);d.push(["pf",navigator.platform||""]);d.push(["dnt",navigator.doNotTrack||""]);d.push(["canv",f()]);return b(d.join("=!!!="))}catch(g){return null}}this.createRequest=function(){function b(b,c){var d={};try{if(b.performance&&b.performance.getEntries){var f=b.performance.getEntries();for(b=0;b<f.length;b++){var g=
f[b],h=g.name.match(/.*\/(.+?)\./);if(h&&h[1]){var F=h[1].replace(/\d+$/,""),k=c[F];if(k){for(var l=0;l<k.stats.length;l++){var m=k.stats[l];d[k.prefix+m.prefix]=Math.round(g[m.name])}delete c[F];if(!e(c))break}}}}return d}catch(na){}}function c(c,d){var f;if(c.frames)for(var g=0;g<c.frames.length;g++)if((f=b(c.frames[g],d))&&e(f))return f}function e(b){var c=0,d;for(d in b)b.hasOwnProperty(d)&&++c;return c}function f(b){if(b&&e(b))for(var c in b)b.hasOwnProperty(c)&&C.push(c+"="+b[c]);else C.push("dvp_noperf=1")}
window._dv_win.$dv.isEval=1;window._dv_win.$dv.DebugInfo={};var d=!1,g=window._dv_win,l=0,m=!1,x=getCurrentTime();window._dv_win.t2tTimestampData=[{dvTagCreated:x}];var k;try{for(k=0;10>=k;k++)if(null!=g.parent&&g.parent!=g)if(0<g.parent.location.toString().length)g=g.parent,l++,d=!0;else{d=!1;break}else{0==k&&(d=!0);break}}catch(F){d=!1}0==g.document.referrer.length?k=g.location:d?k=g.location:(k=g.document.referrer,m=!0);var O="",v=null,r=null;try{window._dv_win.external&&(v=void 0!=window._dv_win.external.QueuePageID?
window._dv_win.external.QueuePageID:null,r=void 0!=window._dv_win.external.CrawlerUrl?window._dv_win.external.CrawlerUrl:null)}catch(F){O="&dvp_extErr=1"}if(!window._dv_win._dvScriptsInternal||!window._dv_win.dvProcessed||0==window._dv_win._dvScriptsInternal.length)return null;d=window._dv_win._dvScriptsInternal.pop();var y=d.script;this.dv_script_obj=d;this.dv_script_obj.ep={ep1:"",ep2:"",ep3:""};this.dv_script=y;window._dv_win.t2tTimestampData[0].dvWrapperLoadTime=d.loadtime;window._dv_win.dvProcessed.push(d);
var h=y.src;this.dv_script_obj.dvSrc=h;void 0!=window._dv_win.$dv.CommonData.BrowserId&&void 0!=window._dv_win.$dv.CommonData.BrowserVersion&&void 0!=window._dv_win.$dv.CommonData.BrowserIdFromUserAgent?d={ID:window._dv_win.$dv.CommonData.BrowserId,version:window._dv_win.$dv.CommonData.BrowserVersion,ID_UA:window._dv_win.$dv.CommonData.BrowserIdFromUserAgent}:(d=dv_GetParam(h,"useragent"),d=(new BrowserDetector).getBrowserIdAndVersion(d?decodeURIComponent(d):navigator.userAgent),window._dv_win.$dv.CommonData.BrowserId=
d.ID,window._dv_win.$dv.CommonData.BrowserVersion=d.version,window._dv_win.$dv.CommonData.BrowserIdFromUserAgent=d.ID_UA);var G=!0,z=window.parent.postMessage&&window.JSON,p=!1;if("0"==dv_GetParam(h,"t2te")||window._dv_win.dv_config&&!0===window._dv_win.dv_config.supressT2T)p=!0;if(z&&!1===p&&5!=window._dv_win.$dv.CommonData.BrowserId)try{var B=S(window._dv_win.dv_config.t2turl||"https://cdn3.doubleverify.com/t2tv7.html");G=M(B)}catch(F){}window._dv_win.$dv.DebugInfo.dvp_HTML5=z?"1":"0";var t=dv_GetParam(h,
"region")||"",w=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream,E=w?"https:":W(),I=w?"https:":X(h);p="0";"https:"===I&&(p="1");try{g.depth=da(g);var q=ea(g);dv_aUrlParam="&aUrl="+encodeURIComponent(q.url);this.dv_script_obj.ep.ep3=encodeURIComponent(q.url);dv_aUrlDepth="&aUrlD="+q.depth;dv_referrerDepth=g.depth+l;m&&g.depth--}catch(F){dv_aUrlDepth=dv_aUrlParam=dv_referrerDepth=
g.depth=""}l=dv_GetDynamicParams(h,"dvp");m=dv_GetDynamicParams(h,"dvpx");for(q=0;q<m.length;q++){var n=dv_GetKeyValue(m[q]);m[q]=n.key+"="+encodeURIComponent(n.value)}"41"==t&&(t=50>100*Math.random()?"41":"8",l.push("dvp_region="+t));l=l.join("&");m=m.join("&");t=window._dv_win.dv_config.tpsAddress||"tps"+t+".doubleverify.com";q="visit.js";switch(dv_GetParam(h,"dvapi")){case "1":q="dvvisit.js";break;case "5":q="query.js";break;default:q="visit.js"}window._dv_win.$dv.DebugInfo.dvp_API=q;var u="ctx cmp ipos sid plc adid crt btreg btadsrv adsrv advid num pid crtname unit chnl uid scusrid tagtype sr dt dup app dvvidver".split(" "),
C=[];for(n=0;n<u.length;n++){var H=dv_GetParam(h,u[n])||"";C.push(u[n]+"="+H);""!==H&&(window._dv_win.$dv.DebugInfo["dvp_"+u[n]]=H)}u="turl icall dv_callback useragent xff timecheck seltag sadv ord litm scrt invs splc adu native gmnpo".split(" ");for(n=0;n<u.length;n++)H=dv_GetParam(h,u[n]),null!=H&&C.push(u[n]+"="+(H||""));(n=dv_GetParam(h,"isdvvid")||"")&&C.push("isdvvid=1");u=dv_GetParam(h,"tagtype")||"";var D=window._dv_win.$dv.getMraid();a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){var A=
!0;break a}}catch(F){}A=!1}H=aa(D,h);C.push("sup="+H);1==n||D||"video"!=u&&"1"!=u||(n=dv_GetParam(h,"adid")||"","function"===typeof _dv_win[n]&&(C.push("prplyd=1"),C.push("DVP_GVACB="+n),C.push("isdvvid=1")));try{var Q=b(window,{dvtp_src:{prefix:"d",stats:[{name:"fetchStart",prefix:"fs"},{name:"duration",prefix:"dur"}]},dvtp_src_internal:{prefix:"dv",stats:[{name:"duration",prefix:"dur"}]}});f(Q)}catch(F){}Q=C.join("&");n=ka();n=null!=n?"&aadid="+n:"";var J=h;t=window._dv_win.dv_config.visitJSURL||
I+"//"+t+"/"+q;w=w?"&dvf=0":"";q=V("maple")?"&dvf=1":"";h=t+"?"+Q+"&dvtagver=6.1.src&srcurlD="+g.depth+"&curl="+(null==r?"":encodeURIComponent(r))+"&qpgid="+(null==v?"":v)+"&ssl="+p+w+q+"&refD="+dv_referrerDepth+"&htmlmsging="+(z?"1":"0")+n+O;D&&(h+="&ismraid=1");A&&(h+="&isovv=1");h+=ba();"http:"==h.match("^http:")&&"https"==window._dv_win.location.toString().match("^https")&&(h+="&dvp_diffSSL=1");g=y&&y.parentElement&&y.parentElement.tagName&&"HEAD"===y.parentElement.tagName;if(!1===G||g)h+="&dvp_isBodyExistOnLoad="+
(G?"1":"0"),h+="&dvp_isOnHead="+(g?"1":"0");l&&(h+="&"+l);m&&(h+="&"+m);g="srcurl="+encodeURIComponent(k);this.dv_script_obj.ep.ep1=encodeURIComponent(k);window._dv_win.$dv.DebugInfo.srcurl=k;if(k=fa())g+="&ancChain="+encodeURIComponent(k),this.dv_script_obj.ep.ep2=encodeURIComponent(k);k=dv_GetParam(h,"uid");null==k?(k=dv_GetRnd(),h+="&uid="+k):(k=dv_GetRnd(),h=h.replace(/([?&]uid=)(?:[^&])*/i,"$1"+k));k=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(k=2E3);A=navigator.userAgent.toLowerCase();
if(-1<A.indexOf("webkit")||-1<A.indexOf("chrome"))A="&referrer="+encodeURIComponent(window._dv_win.location),h.length+A.length<=k&&(h+=A);navigator&&navigator.userAgent&&(A="&navUa="+encodeURIComponent(navigator.userAgent),h.length+A.length<=k&&(h+=A));dv_aUrlParam.length+dv_aUrlDepth.length+h.length<=k&&(h+=dv_aUrlDepth,g+=dv_aUrlParam);k=Y();h+="&vavbkt="+k.vdcd;h+="&lvvn="+k.vdcv;h+="&"+this.getVersionParamName()+"="+this.getVersion();h+="&eparams="+encodeURIComponent(P(g));""!=k.err&&(h+="&dvp_idcerr="+
encodeURIComponent(k.err));d.ID&&(h+="&brid="+d.ID+"&brver="+d.version+"&bridua="+d.ID_UA+"&bds=1",window._dv_win.$dv.DebugInfo.dvp_BRID=d.ID,window._dv_win.$dv.DebugInfo.dvp_BRVR=d.version,window._dv_win.$dv.DebugInfo.dvp_BRIDUA=d.ID_UA);void 0!=window._dv_win.$dv.CommonData.Scenario?d=window._dv_win.$dv.CommonData.Scenario:(d=this.getTrafficScenarioType(window._dv_win),window._dv_win.$dv.CommonData.Scenario=d);h+="&tstype="+d;window._dv_win.$dv.DebugInfo.dvp_TS=d;var K="";try{window.top==window?
K="1":window.top.location.host==window.location.host&&(K="2")}catch(F){K="3"}var L=window._dv_win.document.visibilityState,U=function(){var b=!1;try{b=D&&"function"===typeof D.getState&&"loading"===D.getState()}catch(ma){h+="&dvp_mrgsf=1"}return b},R=U();if("prerender"===L||R)h+="&prndr=1",R&&(h+="&dvp_mrprndr=1");d="dvCallback_"+(window._dv_win.dv_config&&window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():dv_GetRnd());var N=this.dv_script;window._dv_win[d]=function(b,d,e,f){var g=
getCurrentTime();d.$uid=e;var k=T(J);b.tags.add(e,k);k=T(h);b.tags[e].set(k);b.tags[e].beginVisitCallbackTS=g;b.tags[e].set({tagElement:N,dv_protocol:I,protocol:E,uid:e});b.tags[e].ImpressionServedTime=getCurrentTime();b.tags[e].getTimeDiff=function(){return(new Date).getTime()-this.ImpressionServedTime};try{"undefined"!=typeof f&&null!==f&&(b.tags[e].ServerPublicDns=f),b.tags[e].adServingScenario=K,b.tags[e].t2tIframeCreationTime=x,b.tags[e].t2tProcessed=!1,b.tags[e].t2tIframeId=B.id,b.tags[e].t2tIframeWindow=
B.contentWindow,$dv.t2tEventDataZombie[B.id]&&(b.tags[e].uniquePageViewId=$dv.t2tEventDataZombie[B.id].uniquePageViewId,$dv.processT2TEvent($dv.t2tEventDataZombie[B.id],b.tags[e]))}catch(la){}b.messages&&b.messages.startSendingEvents&&b.messages.startSendingEvents(d,e);(function(){function c(){var d=window._dv_win.document.visibilityState;"prerender"===L&&"prerender"!==d&&"unloaded"!==d&&(L=d,b.tags[e].set({prndr:0}),b.registerEventCall(e,{prndr:0}),b&&b.pubSub&&b.pubSub.publishHistoryRtnEvent(e),
window._dv_win.document.removeEventListener(g,c))}function d(){"function"===typeof D.removeEventListener&&D.removeEventListener("ready",d);b.tags[e].set({prndr:0});b.registerEventCall(e,{prndr:0});b&&b.pubSub&&b.pubSub.publishHistoryRtnEvent(e)}if("prerender"===L){var f=window._dv_win.document.visibilityState;if("prerender"!==f&&"unloaded"!==f)b.tags[e].set({prndr:0}),b.registerEventCall(e,{prndr:0}),b&&b.pubSub&&b.pubSub.publishHistoryRtnEvent(e);else{var g;"undefined"!==typeof window._dv_win.document.hidden?
g="visibilitychange":"undefined"!==typeof window._dv_win.document.mozHidden?g="mozvisibilitychange":"undefined"!==typeof window._dv_win.document.msHidden?g="msvisibilitychange":"undefined"!==typeof window._dv_win.document.webkitHidden&&(g="webkitvisibilitychange");window._dv_win.document.addEventListener(g,c,!1)}}else R&&(U()?"function"===typeof D.addEventListener&&D.addEventListener("ready",d):(b.tags[e].set({prndr:0}),b.registerEventCall(e,{prndr:0}),b&&b.pubSub&&b.pubSub.publishHistoryRtnEvent(e)))})();
try{var l=c(window,{visit:{prefix:"v",stats:[{name:"duration",prefix:"dur"}]}});l&&$dv.registerEventCall(e,l)}catch(la){}};(g=ha())&&(h+="&m1="+g);(g=ia())&&0<g.f&&(h+="&bsig="+g.f,h+="&usig="+g.s);h+=ja();(g=Z(J))&&(h+="&"+g);return h+"&jsCallback="+d};this.sendRequest=function(b){window._dv_win.t2tTimestampData.push({beforeVisitCall:getCurrentTime()});var c=this.dv_script_obj&&this.dv_script_obj.injScripts,e=this.dv_script_obj&&this.dv_script_obj.injDvms,f=this.dv_script_obj&&this.dv_script_obj.srcLocation,
d=this.dv_script_obj&&this.dv_script_obj.dvSrc,g=this.dv_script_obj&&this.dv_script_obj.ep||{};c=ca(this.getVersionParamName(),this.getVersion(),b,c,f,d,g,e);b=S("about:blank");e=b.id.replace("iframe_","");b.setAttribute&&b.setAttribute("data-dv-frm",e);M(b,this.dv_script);if(this.dv_script){this.dv_script.id="script_"+e;e=this.dv_script;a:{f=null;try{if(f=b.contentWindow){var l=f;break a}}catch(m){}try{if(f=window._dv_win.frames&&window._dv_win.frames[b.name]){l=f;break a}}catch(m){}l=null}e.dvFrmWin=
l}if(l=N(b))l.open(),l.write(c);else{try{document.domain=document.domain}catch(m){}l=encodeURIComponent(c.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));b.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+l+"');})()"}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){window._dv_win._dvScriptsInternal.unshift(this.dv_script_obj);var b=window._dv_win.dvProcessed,c=this.dv_script_obj;null!=b&&void 0!=b&&c&&(c=b.indexOf(c),
-1!=c&&b.splice(c,1));return window._dv_win.$dv.DebugInfo};this.getTrafficScenarioType=function(b){b=b||window;var c=b._dv_win.$dv.Enums.TrafficScenario;try{if(b.top==b)return c.OnPage;for(var e=0;b.parent!=b&&1E3>e;){if(b.parent.document.domain!=b.document.domain)return c.CrossDomain;b=b.parent;e++}return c.SameDomain}catch(f){}return c.CrossDomain};this.getVersionParamName=function(){return"jsver"};this.getVersion=function(){return"156"}};
